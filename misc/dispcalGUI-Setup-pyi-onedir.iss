...
[Files]
Source: pyi.win32-py%(PythonVersion)s-onedir\dispcalGUI-%(AppVersion)s\*; DestDir: {app}; Flags: ignoreversion recursesubdirs
Source: pyi.win32-py%(PythonVersion)s-onedir\dispcalGUI-%(AppVersion)s\README.html; DestDir: {app}; Flags: ignoreversion isreadme
