...
CalibrationLoadingHandledByDisplayCAL=DisplayCAL Profile Loader (alta precisione ed affidabilità)
CalibrationLoadingHandledByOS=Sistema operativo (bassa precisione ed affidabilità)