...
CalibrationLoadingHandledByDisplayCAL=DisplayCAL Profile Loader (alta precisión y fiabilidad)
CalibrationLoadingHandledByOS=Sistema operativo (baja precisión y fiabilidad)