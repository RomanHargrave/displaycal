...
valid_ranges = {
	...
	"patterngenerator.ffp_insertion.duration": [1, 60],
	"patterngenerator.ffp_insertion.frequency": [1, 3600],
...
defaults = {
	...
	"patterngenerator.ffp_insertion.duration": 5,
	"patterngenerator.ffp_insertion.frequency": 5,
